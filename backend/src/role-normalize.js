...
const OVERRIDE = new Map([
  // 前端
  ['AI Agent 前端', { family: '前端/AI前端', language: 'JavaScript' }],
...
const KEYWORD = [
  { family: '前端/AI前端', kw: ['前端', 'react', 'vue', 'next.js', 'javascript'] },
...
export const CORE_FAMILIES = ['前端/AI前端', 'AI应用开发', '算法/AI', 'AI产品', '视觉/AIGC']
