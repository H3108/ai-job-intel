...
import { Section, Badge, EmptyState, PageHeader, Input, Button, Skeleton } from "../design-system"
          ...
          actions={
            <div className="flex flex-wrap gap-2">
              <Link to="/market" className="no-underline">
                <span className="inline-flex cursor-pointer inline-flex items-center justify-center rounded-xl bg-accent px-4 py-2 text-sm font-medium text-bg transition hover:opacity-90 active:scale-[0.98]">
                  浏览岗位市场
                </span>
              </Link>
              <Link to="/reports" className="no-underline">
                <span className="inline-flex cursor-pointer inline-flex items-center justify-center rounded-xl border border-border px-4 py-2 text-sm text-text transition hover:border-accent/60 active:scale-[0.98]">
                  查看智能分析
                </span>
              </Link>
            </div>
